...
for i=1:n
    ...
    [newtagdata,tagdata]=filterandinterpolatetagdata(temptagdata,tagintervals,framerate,medianfilterorder); % filter and interpolate within these intervals
    assignin('base',strcat('newtag',int2str(monkeygroup2tag(monkeyid,i)),'data'),newtagdata);  % Create a variable in the workspace called newtagidata giving filtered and interpolated data associated with the i'th tag of monkeyid 
end