...
figure;
dD=(cagemin:(cagemax-cagemin)/noofhistogrambinsx:cagemax);
diam=(cagemin:(cagemax-cagemin)/noofhistogrambinsy:cagemax);
dat=monkeybtf(find(monkeybtf(:,1)==monkeyid),3:4);
n = hist3(dat,'Edges',{dD diam}'); % Extract histogram data;
