function tagintervals=getinterpolationintervals(tagdata,timethreshold)
...
x=find(tdiff>timethreshold); % If the difference between two consecutive samples is more than 10 seconds then take that to be a break
